...
POSTS = [
    ...
    dict(id="05", kicker="YÊN TÂM", title="Film chịu trầy\nthay cho máy",
         lines=["Trầy là trầy trên film, máy vẫn nguyên.",
                "Film bong tróc hay nổi bọt do lỗi thi công,",
                "anh chị cứ mang ra tiệm em bảo hành."],
    ...
    dict(id="13", kicker="TRƯỚC KHI CHỌN TIỆM", title="Hỏi 3 câu này\nlà biết chỗ ngon",
         lines=["1. Có cắt bằng máy CNC theo model không?",
                ...
                "3. Bảo hành thế nào nếu bong tróc, nổi bọt?"],
         chips=[], theme=5),
